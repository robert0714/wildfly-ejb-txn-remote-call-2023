 ...
 */
@Stateless
@Remote (RemoteBeanEx01EndInterface.class)
public class StatelessBeanEx01End implements RemoteBeanEx01EndInterface {
    private static final Logger log = Logger.getLogger(StatelessBeanEx01End.class);
