...
package org.jboss.as.quickstarts.ejb.server.experiment.nested.tx;
 ...
 */
@Stateless
@Remote (RemoteBeanEx02Interface.class)
public class StatelessBeanExt02 implements RemoteBeanEx02Interface {
    private static final Logger log = Logger.getLogger(StatelessBeanExt02.class);
